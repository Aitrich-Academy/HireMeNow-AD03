...
namespace Domain.Migrations
{
    ...
    [Migration("20250922101850_CreatorIDConnectionAddedInJobPOst")]
    partial class CreatorIDConnectionAddedInJobPOst
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.JobPost", b =>
                {
                    b.HasOne("CompanyUser", "JobCreatorID")
                        .WithMany("JobPosts")
                        .HasForeignKey("CreatorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JobCreatorID");
                });
